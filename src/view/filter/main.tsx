    ...
    return (
        <main className="max-w-[1350px] mx-auto">
            <div className="grid gap-[30px] my-[30px] md:grid-cols-[2fr_1fr] grid-col-1">
                <div className="bg-white shadow-lg p-[20px] rounded-[10px]">
                    <div className="flex justify-between items-center mb-[20px] pb-[10px] border-b-2 border-gray-200">
                    ...
                    <div className="grid grid-col-1 md:grid-cols-2 gap-[20px] w-full">
                ...
                <div className="bg-white shadow-lg p-[20px] rounded-[10px]"></div>
            </div >
        </main >
    )
}
